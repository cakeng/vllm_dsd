...
with open("benchmarks/dsd/offline/result", "a") as f:
    f.write("batch_size, input_len, output_len, acc_rate, num_spec_token, org_time, org_tpt, batch_expansion_time, batch_expansion_tpt, mqa_time, mqa_tpt\n")
    f.write(f"{batch_size}, {input_len}, {acc_rate}, {num_speculative_tokens}, {output_len}, {org_time}, {org_tpt}, {batch_expansion_time}, {batch_expansion_tpt}, {mqa_time}, {mqa_tpt}\n")